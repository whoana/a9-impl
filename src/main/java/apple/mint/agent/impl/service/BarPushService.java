...
public class BarPushService extends PushService {
    ...
    public BarPushService(String cd, String name, ServiceContext serviceContext, SendChannelWrapper sendChannelWrapper, Map params, Boolean disabled) {
